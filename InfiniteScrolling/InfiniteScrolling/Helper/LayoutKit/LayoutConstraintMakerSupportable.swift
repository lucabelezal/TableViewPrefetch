...
public class LayoutConstraintMakerSupportable {
    ...
    @discardableResult public func priority(_ priority: LayoutPriortizable) -> LayoutConstraintMakerSupportable {
    ...
    @discardableResult public func reference(_ reference: inout LayoutConstraint?) -> LayoutConstraintMakerSupportable {
        reference = constant
        return LayoutConstraintMakerSupportable(constant: constant)
    }
    
    @discardableResult public func insetSafeArea(_ inset: LayoutEdgeInsets) -> LayoutConstraintMakerSupportable {
        guard let constant = constant else {
            return LayoutConstraintMakerSupportable(constant: self.constant)
        }
